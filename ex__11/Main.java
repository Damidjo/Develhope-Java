...
public class Main {
    ...
    public static void exercise2() {
        ...
        int inputNumber = 17;
System.out.println("L'input del number:" + inputNumber);
        // Your switch statement here
        switch (inputNumber) {
            case 2:
                System.out.println("This is the first largest prime number under 20");
                break;
            case 3:
                System.out.println("This is the 1th first largest prime number under 20");
                break;
            case 5:
                System.out.println("This is the 2th first largest prime number under 20");
                break;
            case 7:
                System.out.println("This is the 3th first largest prime number under 20");
                break;
            case 11:
                System.out.println("This is the 4th largest prime number under 20");
                break;
            case 13:
                System.out.println("This is the 5h first largest prime number under 20");
                break;
            case 17:
                System.out.println("This is the first 6th largest prime number under 20");
                break;
            case 19:
