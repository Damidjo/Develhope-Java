...
public class Main {
    ...
    private static void exercise3() {
        ...
        //Se maggiore rispetto al valore della variabile l'output sarà Greater than
        if (ourDouble > 2.5) {
            System.out.println("Greater than");
            //In questo punto ho dovuto chiedere aiuto al web, ma ho anche capito il perchè di questa procedura
            //Da quello che ho capito è come se confrontasse questo "nuovo valore"
            //E se ancora minore aggiungendo uno, l'output sarà "Still less than"
        } else {
            ourDouble += 1.0;
            if (ourDouble < 2.5) {
